...
import { preload, EventEnvelope, Logger, AsyncHttpRequest, ObjectStreamReader, AppException, ObjectStreamIO, ObjectStreamWriter, PostOffice } from 'mercury-composable';
...
export class HelloWorld {
    ...
    async renderMultiPartFileStream(streamId, filename) {
        let n = 0;
        let len = 0;
        let eof = false;
...
], HelloWorld.prototype, "initialize", null);
